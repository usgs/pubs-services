		...
		if (null != value && null != context &&
			...
			for (Map<String, Object> series : dups.values()) {
				...
				if (checkValue(series, NAME_MATCH)) {
					Object[] messageArguments = new String[]{"Name " + value.getText(), series.get(ID).toString()};
				...
				if (checkValue(series, CODE_MATCH)) {
					Object[] messageArguments = new String[]{"Code " + value.getCode(), series.get(ID).toString()};
					String errorMsg = PubsUtils.buildErrorMsg(context.getDefaultConstraintMessageTemplate(), messageArguments); 
				...
				if (checkValue(series, DOI_NAME_MATCH)) {
					Object[] messageArguments = new String[]{"DOI Name " + value.getSeriesDoiName(), series.get(ID).toString()};
					String errorMsg = PubsUtils.buildErrorMsg(context.getDefaultConstraintMessageTemplate(), messageArguments); 
				...
				if (checkValue(series, PRINT_ISSN_MATCH)) {
					Object[] messageArguments = new String[]{"Print ISSN " + value.getPrintIssn(), series.get(ID).toString()};
					String errorMsg = PubsUtils.buildErrorMsg(context.getDefaultConstraintMessageTemplate(), messageArguments); 
				...
				if (checkValue(series, ONLINE_ISSN_MATCH)) {
					Object[] messageArguments = new String[]{"Online ISSN " + value.getOnlineIssn(), series.get(ID).toString()};
					String errorMsg = PubsUtils.buildErrorMsg(context.getDefaultConstraintMessageTemplate(), messageArguments); 
