...
@SpringBootTest(webEnvironment=WebEnvironment.MOCK,
	classes={TestSecurityConfig.class, SecurityConfig.class, ConfigurationService.class,
			PubsAuthenticationProvider.class, TokenSecurityFilter.class, UnauthorizedEntryPoint.class,
			FreemarkerConfig.class, PublicationBusService.class,
			PublicationType.class, PublicationTypeDao.class, DbTestConfig.class,
			PublicationSubtype.class, PublicationSubtypeDao.class, PublicationSeries.class,
			PublicationSeriesDao.class, CostCenter.class, CostCenterDao.class, AffiliationDao.class,
			OutsideAffiliation.class, OutsideAffiliationDao.class, ContributorType.class,
			ContributorTypeDao.class, LinkType.class, LinkTypeDao.class, LinkFileType.class,
			LinkFileTypeDao.class, PersonContributor.class, PersonContributorDao.class,
			ContributorDao.class, CorporateContributor.class, CorporateContributorDao.class,
			PublishingServiceCenter.class, PublishingServiceCenterDao.class})
public abstract class BaseEndpointSecurityIT extends BaseIT {
	...
	public void postSetup() {
		...
		pwPubMvc = new PwPublicationMvcService(pwPubBusService, configurationService, contentStrategy,
				templateConfiguration, publicationBusService);
		mockPwPub = MockMvcBuilders.standaloneSetup(pwPubMvc).addFilters(springSecurityFilter).build();
		pwPubRssMvc = new PwPublicationRssMvcService(pwPubBusService, configurationService);
		...
		mockVersion = MockMvcBuilders.standaloneSetup(new VersionController()).addFilters(springSecurityFilter).build();
