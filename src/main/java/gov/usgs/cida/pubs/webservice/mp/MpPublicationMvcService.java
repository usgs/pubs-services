...
//	}
//	
//	@RequestMapping(value = "publications/{id}", method = RequestMethod.PUT, produces="application/json")
//	@ResponseBody
//	@Transactional
//	public Map<String,? extends Object> updatePub(@RequestBody MultiValueMap<String, String> body, @PathVariable String id, HttpServletResponse response) {
//		MpPublication pub = getDomainFromExtRequest(body, new MpPublication());
