...
public class PubsEMailer {
	...
	private final String pubsEmailList;
	private final String mailHost;

	@Autowired
	public PubsEMailer(@Qualifier("pubsEmailList") String pubsEmailList,
			@Qualifier("mailHost") String mailHost) {
		this.pubsEmailList = pubsEmailList;
