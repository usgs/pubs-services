...
@SpringBootTest(webEnvironment=WebEnvironment.NONE,
	classes={DbTestConfig.class, TestSpringConfig.class, LocalValidatorFactoryBean.class,
			PersonContributorBusService.class, IpdsCostCenterService.class, IpdsParserService.class,
...
public class IpdsUsgsContributorServiceIT extends BaseIpdsTest {
	...
	public void getByORCIDMultipleTest() throws SAXException, IOException {
		...
		ContributorDaoIT.assertContributor4(contributor);
	}
