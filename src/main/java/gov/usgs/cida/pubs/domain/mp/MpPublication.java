...
@JsonPropertyOrder({"id", "indexId", "displayToPublicDate", "lastModifiedDate", "publicationType", "publicationSubtype",
	...
	"subchapterNumber","displayTitle", "title", "docAbstract", "usgsCitation", "programNote", "collaboration", "language", "publisher", "publisherLocation",
	...
	"temporalEnd", "notes", "ipdsReviewProcessState", "lockUsername","contributors", "links", 
